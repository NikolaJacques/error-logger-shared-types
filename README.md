...
| Property | Description | Type | Default |
|-----------------------------------------|
| error | an error object containing error information (see below) | object | no default |
...
| Property | Description | Type | Default |
|-----------------------------------------|
| event handler | the event handler in the event listener | function | no default |
